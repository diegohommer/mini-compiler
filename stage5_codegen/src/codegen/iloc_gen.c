...
void iloc_gen_while(asd_tree_t* output, asd_tree_t* exp, asd_tree_t* cmd_block)
{
    ...
    // Labels
    iloc_op_t* label_start = iloc_op_new(OP_LABEL, start_id, UNUSED_OPERAND, UNUSED_OPERAND);
    iloc_op_t* label_body = iloc_op_new(OP_LABEL, body_id, UNUSED_OPERAND, UNUSED_OPERAND);
    iloc_op_t* label_end = iloc_op_new(OP_LABEL, end_id, UNUSED_OPERAND, UNUSED_OPERAND);
    ...
    iloc_op_t* jump_back = iloc_op_new(OP_JUMPI, start_id, UNUSED_OPERAND, UNUSED_OPERAND);
