...
{
    iloc_op_list_t* code = iloc_op_list_new();
    iloc_op_t* i2i = iloc_op_new(OP_I2I, exp->temp, 1, UNUSED_OP);
    iloc_op_t* halt = iloc_op_new(OP_HALT, UNUSED_OP, UNUSED_OP, UNUSED_OP);
    iloc_op_list_add_op(code, i2i);
    iloc_op_list_add_op(code, halt);
