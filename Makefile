...
# Files
_DEPS = parser.tab.h asd.h symbol_table.h scope_stack.h type_infer.h iloc_ir.h iloc_gen.h errors.h
DEPS = $(_DEPS)
...
clean:
	rm -f *.o etapa5 parser.tab.h parser.tab.c lex.yy.c -f $(IDIR)/parser.tab.h $(SDIR)/lexical/lex.yy.c $(SDIR)/syntax/parser.tab.c
